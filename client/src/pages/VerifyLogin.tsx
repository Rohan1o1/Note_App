...
const VerifyLogin = () => {
  ...
  const handleResendOtp = () => {
    ...
    // Example: api.post('/auth/login/resend-otp', { email })
    alert('OTP resent!');
  };
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center items-center px-4 py-8 md:p-16 bg-white">
        <div className="w-full max-w-md rounded-xl border md:border-none md:shadow-none shadow-lg p-6 md:p-0">
          ...
          <div className="flex flex-col items-start mb-6 ">
            ...
            <img src="/public/logo.png" alt="HD Logo" className="w-8 h-8 mb-2" />
            <h3>HD</h3>
            </div>
            <h2 className="text-2xl md:text-3xl font-bold mb-1 text-gray-900">Sign in</h2>
          ...
          <div className="space-y-4">
            ...
            <div className="relative">
              ...
              <button type="button" onClick={() => setShowOtp(v => !v)}
                className="absolute right-2 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 m-2">
                {showOtp ? (
            ...
            <div className="flex items-start justify-left flex-col text-xs p-3 gap-2">
              <button type="button" onClick={handleResendOtp} className="text-blue-600 hover:underline mt-3">Resend OTP</button>
          ...
          <Button text="Sign in" onClick={handleVerify} className="mt-6 bg-[#2563eb] hover:bg-[#1d4ed8] text-base font-semibold" />
